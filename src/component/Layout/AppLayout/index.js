...
import TestLogin from '../../Hello/TestLogin';
...
export default class AppLayout extends Component {
    render() {
        return <div className="app-layout-container">
            <TestLogin/>
            <Layout>
                <Header className="header">
                    <div className="logo"/>
                    <Nav theme="dark" style={{lineHeight: '64px'}}/>
                </Header>
                <Layout>
                    ...
                    <Layout style={{padding: '0 24px 24px'}}>
                        ...
                        <Content style={{background: '#fff', padding: 24, margin: 0, height: '90vh'}}>
